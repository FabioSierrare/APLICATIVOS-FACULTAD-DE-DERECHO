...
export default function RegisterShiftPage() {
  ...
  // Matriz de días del mes de Agosto 2026 (Empieza en Sábado 1 = offset de 5 espacios)
  const calendarDays = [
    null,
    null,
    null,
  ...
  return (
    <div className="min-h-screen bg-slate-100 sm:p-8 flex items-center justify-center font-sans text-slate-800">
      <div className="w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100">
        {/* ================= ENCABEZADO PÚRPURA ================= */}
        <div className="bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-800 text-white sm:p-8 relative overflow-hidden">
          {/* Marca de agua de calendario en la esquina derecha */}
        ...
        <div className="p-3 sm:p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start pl-0 sm:pl-10">
              ...
              <div className="md:col-span-7 m-auto bg-white border border-slate-200 rounded-2xl sm:p-5 shadow-sm">
                <DatePickerWithBlocks selected={Fecha} onSelect={setFecha} />
              </div>

              {/* Panel Lateral de Fecha Seleccionada */}
              <div className="md:col-span-5 bg-purple-50/60 border border-purple-100 rounded-2xl p-5 space-y-4">
            ...
            <div className="pl-0 sm:pl-10">
              <div className="relative flex items-center border border-slate-200 rounded-2xl bg-white p-2 shadow-sm hover:border-slate-300 transition-colors">
                ...
                >
                  ...
                  <option value="MARIA PAULA GONZALEZ">
                    MARIA PAULA GONZALEZ
                  </option>
                  <option value="JUAN CAMILO RODRIGUEZ">
