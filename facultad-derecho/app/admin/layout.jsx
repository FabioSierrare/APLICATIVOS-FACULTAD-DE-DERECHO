...
import { PlusCircle, Calendar, Clock, ArrowLeftRight, User, UserPlus, CalendarX2 } from "lucide-react";
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="start">
            ...
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem onClick={() => router.push("/admin/bloqueo-dias")}>
                Bloquear dias del calendario
                <DropdownMenuShortcut>
                  <CalendarX2 className="w-4"/>
                </DropdownMenuShortcut>
              </DropdownMenuItem>
